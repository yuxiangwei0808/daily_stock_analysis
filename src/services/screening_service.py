...
def _normalize_candidate(raw: Any, rank: int) -> Dict[str, Any]:
    ...
    return {
        ...
        "quote_session": _first_present(item, source, "quote_session"),
        "provider_timestamp": _first_present(item, source, "provider_timestamp"),
        "reference_price": _first_present(item, source, "reference_price"),
        "is_stale": _first_present(item, source, "is_stale"),
